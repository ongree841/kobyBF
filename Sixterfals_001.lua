blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(getgenv().Setting))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Under Hub Scripts /Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function savesettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Under Hub Scripts /Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Under Hub Scripts /Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
...
httpsreq({
		...
		repeat wait(1) until game:IsLoaded()if string.lower(game:GetService("RbxAnalyticsService"):GetClientId()) == game:GetService("RbxAnalyticsService"):GetClientId() then
			...
			ImageButton.BackgroundColor3 = Color3.fromRGB(211,17,97)
					...
					repeat task.wait()
						...
						if _G.Type==1 then
						   ...
						   elseif _G.Type==2 then
							topos(game:GetService("Players")[getgenv().SelectPly].Character.HumanoidRootPart.CFrame*CFrame.new(0,0,0))
			...
			while task.wait() do
				pcall(function()
					...
					if not shared.cpc then shared.cpc = STOP.play end
						...
						if Hits then
            								if getgenv().LongSword or _G.AutoEliteHunter or getgenv().TwinHooks or getgenv().DragonTrident or getgenv().AutoFarm or getgenv().BuddySword or getgenv().SerpentBow or _G.Tushitahop or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or Auto_Twin_Hooks or getgenv().DarkDagger or Auto_Dragon_Trident or _G.AutoSaber or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.Auto_kill_Canvander or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or getgenv().DragonTrident or _G.Clip or FarmBoss or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or getgenv().Canvander or _G.AutoFactory or Pole_Farm or Auto_Serpent_Bow or Auto_Canvander or getgenv().LegendarySwor or _G.AutoSaber2 or _G.AutoFarmAllBoss or _G.SupperFast or _G.Auto_Next_Island or _G.AutoNextIsland or _G.Auto_Farm_Ectoplasm or getgenv().PoleSword or _G.Auto_Open_Dough_Dungeon or _G.Auto_Farm_Chest or _G.Auto_Soul_Reaper or _G.Auto_Cake_Prince or _G.Auto_Saber or _G.FastFarmPlayer or Auto_Cursed_Dual_Katana or AutoFarmMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or getgenv().AutoThirdSea or _G.FastFarmPlayer1 or _G.Auto_Mystic_Island or _G.Auto_kill_Empress or _G.Auto_kill_Captain or _G.Auto_kill_Captains or _G.Auto_Next_Island2 or _G.BringFruit2 or _G.AutoTideKeeper or _G.AutoSwordSword or _G.FastFarmx or getgenv().AutoBone or getgenv().cakefarm or getgenv().Ectoplasm or getgenv().FarmBoss or getgenv().FarmAllBoss or getgenv().Elitehunter or _G.AutoMasterySwrod or getgenv().swordmas or getgenv().cakefarm or _G.FastFarmMode or getgenv().BossHallow or getgenv().Second or getgenv().PirateRaid or getgenv().Mobaura or _G.Attack_Xenon2 then
...
task.spawn(function()
	while wait() do 
		AttackRandomType = math.random(1,8)
		wait(0.1)
	end
end)
									...
									repeat task.wait()
										if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
											if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
												...
												EquipWeapon(_G.SelectWeapon)
												--topos(v.HumanoidRootPart.CFrame * CFrame.new(0,37,13))
												...
												if _G.Type==1 then
												   ...
												   elseif _G.Type==2 then
													topos(v.HumanoidRootPart.CFrame*CFrame.new(0,0,40));
												   elseif _G.Type==3 then
													topos(v.HumanoidRootPart.CFrame*CFrame.new(-40,0,0));
												   elseif _G.Type==4 then
													topos(v.HumanoidRootPart.CFrame*CFrame.new(40,0,0));
...
_G.ColorMethod = Color3.fromRGB(255, 0, 127)
...
local TextButton77 = Instance.new("TextButton")
	...
	TextButton8.Size = UDim2.new(0, 198, 0, 48)--UDim2.new(0, 198, 0, 48)
	...
	TextButton8_UiConner.CornerRadius = UDim.new(0, 40)
	TextButton8_UiConner.Parent = TextButton8
	
	ToggleImgUi.Name = "ToggleImgUi"
	ToggleImgUi.Parent = TextButton8
	ToggleImgUi.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	ToggleImgUi.BackgroundTransparency = 1.000
	ToggleImgUi.Position = UDim2.new(0.04545455468, 40, 202.1245000313, 0)
	ToggleImgUi.Size = UDim2.new(6, 35, 5, 40)
...
local IMGNAME = Instance.new("ImageLabel")
	...
	--        TextButton_3_Toggle.BorderColor3 = _G.ColorMethod
			...
			HueSelection.Image = "http://www.roblox.com/asset/?id="
	...
	Date = os.date("%d".." ".."%B".." ".."%Y")
local Window = create:win("Test"..Date)
...
spawn(function()
    while task.wait() do
        if getgenv().PirateRaid then
            pcall(function()
            local Ms = {"Sea Soldier [Lv. 1506]","Ship Officer [Lv. 1428]","Hored Warner [Lv. 1559]","Galley Pirate [Lv. 1528]","Vampire [Lv. 1443]","Snow Trooper [Lv. 1585]","Snow Lurker [Lv. 1547]"}
                for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                    if v.Name == Ms then
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            repeat task.wait()
								...
								_G.Attack_Xenon = true
								MagnetSword = true
                            until not getgenv().PirateRaid or not v.Parent or v.Humanoid.Health <= 0
							_G.Attack_Xenon = false
							MagnetSword = false
                        end
                    end
...
Main:Line() 
local Levelz = Main:Label("Name :")
spawn(function()
	while true do
		Levelz:Change("Name :".. game.Players.LocalPlayer.Name)
		game:GetService("RunService").RenderStepped:Wait()
	end
end)
local Level = Main:Label("Level :")
spawn(function()
	while true do
		Level:Change("Level :".. game:GetService("Players")["LocalPlayer"].Data.Level.Value)
		game:GetService("RunService").RenderStepped:Wait()
	end
end)

    Main:Toggle("Auto Farm Level",getgenv().Setting["Auto Farm Level"],function(value)
	...
	Main:Toggle("Chams Enabled",Chams,function(value)
		Chams = value
    end)
	task.spawn(function ()
		while true do
...
Main:Line()
	...
	if World1 then
		Main:Toggle("Player Quest",_G.FastFarmMode,function(value)
			game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest");
			wait(2)
		...
		while wait() do
			pcall(function()
					if MyLevel >= 15 and MyLevel <= 70 then
						if _G.FastFarmMode then
						getgenv().AutoFarm = false
					local MyLevel = game.Players.LocalPlayer.Data.Level.Value
					if game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]") then
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if v.Name == "God's Guard [Lv. 450]" and v.Humanoid.Health > 0 then
								repeat task.wait()
									AutoHaki()         
									EquipWeapon(_G.SelectWeapon)
									...
									PosMon = v.HumanoidRootPart.CFrame    
									if _G.Type==1 then
										topos(v.HumanoidRootPart.CFrame*CFrame.new(0,10,-50));
									elseif _G.Type==2 then
										topos(v.HumanoidRootPart.CFrame*CFrame.new(50,1,0));
									  elseif _G.Type==3 then
										topos(v.HumanoidRootPart.CFrame*CFrame.new(-50,1,0));
									   elseif _G.Type==4 then
										topos(v.HumanoidRootPart.CFrame*CFrame.new(0,1,50));
									   end
									MagnetSword = true                               
									game:GetService("VirtualUser"):CaptureController()
									game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
									...
									v.Humanoid.WalkSpeed = 0
									_G.Attack_Xenon2 = true
								until v.Humanoid.Health <= 0 or _G.FastFarmMode == false
								_G.Attack_Xenon2 = false
								MagnetSword = false
							end
						end
				...
				spawn(function()
					game:GetService("RunService").RenderStepped:Connect(function()
					 pcall(function()
						 if getgenv().AutoBone or getgenv().cakefarm then
					 if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
					 local args = {
					 [1] = "Buso"
					 }
...
pcall(function()
	if _G.AutoConfetti then
		if game.PlaceId == 4442272183 then
			topos(CFrame.new(-11.848626136779785, 19.311767578125, 2828.531005859375))
			topos(CFrame.new(-375.93408203125, 73.11296844482422, 1180.5146484375))
			topos(CFrame.new(-2070.090576171875, 72.37596893310547, -2689.849853515625))
			topos(CFrame.new(-5365.74462890625, 9.003767013549805, -705.3399658203125))
			topos(CFrame.new(880.24462890625, 125.09214782714844, 32865.26171875))
			topos(CFrame.new(-5610.93798828125, 18.35700798034668, -5015.65869140625))
			topos(CFrame.new(-3014.4755859375, 29.575407028198242, -9777.16015625))
			topos(CFrame.new(113.77246856689453, 401.45697021484375, -5192.54248046875))
			topos(CFrame.new(5585.3740234375, 12.449106216430664, -5954.33349609375))
		elseif game.PlaceId == 7449423635 then
			topos(CFrame.new(-259.380126953125, 6.764979839324951, 5254.09912109375))
			topos(CFrame.new(-1932.3507080078125, 13.824933052062988, -11636.8515625))
			topos(CFrame.new(-929.170166015625, 7.802646160125732, -10826.3876953125))
			topos(CFrame.new(497.3184509277344, 24.76936149597168, -12418.55859375))
			topos(CFrame.new(-47.42597961425781, 16.97955322265625, -11992.779296875))
			topos(CFrame.new(2245.78271484375, 12.776296615600586, -6353.974609375))
i,v in pairs(game:GetService("Workspace"):GetChildren()) do
						if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
							...
							until not v.Parent or getgenv().Grabchest == false
						end
					end
				else
					if getgenv().GrabchestHop then
						Hop()
					end
				end
			end)
...
Main:Toggle("Grab chest",getgenv().Grabchest,function(value)
	getgenv().Grabchest = value
	StopTween(getgenv().Grabchest)
end)
Main:Toggle("Grab chest Hop",getgenv().GrabchestHop,function(value)
	getgenv().GrabchestHop = value
end)

Main:Label("👻 Aura 👻")
Main:Toggle("Mob Aura",getgenv().Mobaura,function(value)
...
spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
     pcall(function()
     for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
         if getgenv().Mobaura or getgenv().cakefarm or getgenv().AutoBone or _G.FastFarmMode == true  then
		...
		while wait() do
			pcall(function()
				if _G.AutoFarmFruitMastery then
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
						if getgenv().Mobaura and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 500 then
							repeat wait()
								HealthMs = v.Humanoid.MaxHealth * 20
	...
	StartMagnet = true
							...
							until not _G.AutoFarmFruitMastery or not v.Parent or v.Humanoid.Health <= 0
							_G.Attack_Xenon = false
							StartMagnet = false
						end
					end
...
Main:Label("😋 Sword Mas 😋")



Main:Toggle("Auto Sword Mas",false,function(vu)
	getgenv().swordmas = vu
	StopTween(getgenv().swordmas)
end)
		...
		if tostring(method) == "FireServer" then
			if tostring(args[1]) == "RemoteEvent" then
				if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
					if UseSkillMasteryDevilFruit and _G.AutoMasteryF then
			...
			if SelectWeaponGun then
				if SelectWeaponGun == "Soul Guitar" then
					if tostring(args[2]) == "TAP" then
						if _G.AutoMasteryG and UseSkillMasteryGun then
...
task.spawn(function()
	...
	spawn(function()
		while wait() do
			pcall(function()
				if getgenv().swordmas then
					if game:GetService("Workspace").Enemies:FindFirstChild("Galley Captain [Lv. 650]") then
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if v.Name == "Galley Captain [Lv. 650]" and v.Humanoid.Health > 0 then
								repeat task.wait()
									AutoHaki()         
									EquipWeaponSword()
	...
	_G.Fast_Attack_Normal = true;
								until v.Humanoid.Health <= 0 or getgenv().swordmas == false
								_G.Fast_Attack_Normal = false
								MagnetSword = false
							end
						end
					else
						topos(CFrame.new(5649, 39, 4936))
					end
				end
			end)
		end
...
if World1 then
	Main:Label("🎄 Pole 🎄")
Main:Toggle("Auto Pole",getgenv().PoleSword,function(value)
	getgenv().PoleSword = value
	StopTween(getgenv().PoleSword)
end)
end
if World1 then
Main:Toggle("Auto Pole Hop",getgenv().PoleSwordHop,function(value)
	getgenv().PoleSwordHop = value
end)
end
if World2 then
	Main:Label("🎄 Factory 🎄")
	...
	if World2 then
		...
		spawn(function()
			while wait() do
				if getgenv().LegendarySword then
					pcall(function()
						local args = {
						...
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
						if getgenv().LegendarySwordHop and getgenv().LegendarySword and World2 then
							wait(10)
							Hop()
						end
					end)
		...
		if World2 then
			...
			Main:Toggle("Buy Legendary",getgenv().LegendarySword,function(value)
				getgenv().LegendarySword = value
			end)
			end
			if World2 then
			Main:Toggle("Legendary Hop",getgenv().LegendarySwordHop,function(value)
				getgenv().LegendarySwordHop = value
			end)
			end
			if World2 then
				Main:Label("🎄 Swan Glasses 🎄")
				Main:Toggle("Auto Swan Glasses",getgenv().SwanGlasses,function(value)
					getgenv().SwanGlasses = value
					StopTween(getgenv().SwanGlasses)
				end)
				end
				if World2 then
				Main:Toggle("Swan Glasses Hop",getgenv().SwanGlassesHop,function(value)
					getgenv().SwanGlassesHop = value
				end)
				end
if World2 then
	Main:Label("🎊 Dragon Trident 🎊")
	Main:Toggle("Auto Dragon Trident",getgenv().DragonTrident,function(value)
		getgenv().DragonTrident = value
		StopTween(getgenv().DragonTrident)
	end)
	end
	if World2 then
	Main:Toggle("Dragon Trident Hop ",getgenv().DragonTridentHop,function(value)
	...
	if World2 then
		...
		Main:Toggle("Auto Long Sword",getgenv().LongSword,function(value)
            getgenv().LongSword = value
            StopTween(getgenv().LongSword)
		end)
		end
		if World2 then
			Main:Toggle("Long Sword Hop",getgenv().LongSwordHop,function(value)
	...
	if World3 then
		...
		Main:Toggle("Auto Buddy Sword",getgenv().BuddySword,function(value)
            getgenv().BuddySword = value
            StopTween(getgenv().BuddySword)
		end)
		end
		if World3 then
		Main:Toggle("Buddy Sword Hop",getgenv().BuddySwordHop,function(value)
			getgenv().BuddySwordHop = value
		end)
		end
		if World3 then
			Main:Label("🎩 Valkyrie Helmet 🎩")
			Main:Toggle("Valkyrie Helmet",getgenv().DarkDagger,function(value)
				getgenv().DarkDagger = value
				StopTween(getgenv().DarkDagger)
			end)
			end
			if World3 then
			Main:Toggle("Valkyrie Helmet Hop",getgenv().DarkDaggerHop,function(value)
				getgenv().DarkDaggerHop = value
			end)
			end
			if World3 then
				Main:Label("🎃 Dark Dagger 🎃")
				Main:Toggle("Auto Dark Dagger",getgenv().DarkDagger,function(value)
					getgenv().DarkDagger = value
					StopTween(getgenv().DarkDagger)
				end)
				end
				if World3 then
				Main:Toggle("Dark Dagger Hop",getgenv().DarkDaggerHop,function(value)
					getgenv().DarkDaggerHop = value
				end)
				end
				if World3 then
					Main:Label("✨ Serpent Bow ✨")
					Main:Toggle("Auto Serpent Bow",getgenv().SerpentBow,function(value)
					...
					if World3 then
					Main:Toggle("Serpent Bow Hop",getgenv().SerpentBowHop,function(value)
						getgenv().SerpentBowHop = value
					end)
					end
					if World3 then
						Main:Label("🧵 Twin Hooks 🧵")
						Main:Toggle("Auto Twin Hooks",getgenv().TwinHooks,function(value)
							getgenv().TwinHooks  = value
							StopTween(getgenv().TwinHooks)
						end)
						end
						if World3 then
						Main:Toggle("Twin Hooks Hop",getgenv().TwinHooksHop,function(value)
							getgenv().TwinHooksHop = value
						end)
						end
						if World3 then
							Main:Label("🎗 Canvander 🎗")
							Main:Toggle("Auto Canvander",getgenv().Canvander,function(value)
								getgenv().Canvander = value
								StopTween(getgenv().Canvander)
							end)
							end
							if World3 then
								Main:Toggle("Canvander Hop",getgenv().CanvanderHop,function(value)
									getgenv().CanvanderHop = value
								end)
								end
...
spawn(function()
	while wait() do
		pcall(function()
			if getgenv().Canvander and game.ReplicatedStorage:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") or game.Workspace.Enemies:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") then
				if game.Workspace.Enemies:FindFirstChild("Beautiful Pirate [Lv. 1950] [Boss]") then
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
						if getgenv().Canvander and v.Name == "Beautiful Pirate [Lv. 1950] [Boss]" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							repeat wait()  
								AutoHaki()
								EquipWeapon(_G.SelectWeapon)
								topos(v.HumanoidRootPart.CFrame * CFrame.new(0,20,3))
								...
								v.Humanoid.WalkSpeed = 0
								_G.Attack_Xenon = true
							until not getgenv().Canvander or v.Humanoid.Health <= 0 or not v.Parent
							_G.Attack_Xenon = false
						end
					end
				else
...
Main:Toggle("God Human Fully",getgenv().GodhumanFully,function(value)
...
spawn(function()
	pcall(function()
		while wait(.1) do
			if (getgenv().SwanGlasses and getgenv().SwanGlassesHop) and World2 and not game:GetService("ReplicatedStorage"):FindFirstChild("Don Swan [Lv. 1000] [Boss]") and not game:GetService("Workspace").Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
				Hop()
			end
		end
	end)
...
--end)
	...
	coroutine.wrap(function()
		while task.wait(.2) do
			local ac = CombatFrameworkR.activeController
			if ac and ac.equipped then
				if _G.Attack_Xenon then
					AttackFunction()
					if _G.Attack_Xenon then
						if tick() - cooldownfastattack > .5 then wait(.1) cooldownfastattack = tick() end
					end
				elseif _G.Attack_Xenon == true then
					if ac.hitboxMagnitude ~= 45 then
						ac.hitboxMagnitude = 45
					end
					ac:attack()
				end
			end
	...
	coroutine.wrap(function()
		while task.wait(.2) do
			local ac = CombatFrameworkR.activeController
			if ac and ac.equipped then
				if _G.SupperFast then
					AttackFunction()
					if _G.SupperFast then
						if tick() - cooldownfastattack > .5 then wait(.1) cooldownfastattack = tick() end
					end
				elseif _G.SupperFast == true then
					if ac.hitboxMagnitude ~= 45 then
						ac.hitboxMagnitude = 45
					end
					ac:attack()
		...
		Main2:Line()
		Main2:Toggle("Auto Attack",false,function(value)
			_G.SupperFast = value
		end)
		Main2:Toggle("Disabled Damage",false,function(value)
			_G.DisabledDamage = value
		end)
		Main2:Line()

		Main2:Toggle("Black Screen (CPU)",false,function(value)
...
Main2:Toggle("Bypass TP (Working)",_G.Bypassse,function(value)
	_G.Bypassse = value
	StopTween(_G.Bypassse)
end)
Main2:Line()
		Main2:Toggle("Auto Haki (High)",false,function(value)
		_G.Haki = value
    end)
	Main2:Toggle("Set Spawn (Home)",false,function(value)
		_G.SetSpawnPoint = value
    end)
	Main2:Toggle("Auto Rejoin (Kick)",true,function(value)
		_G.AutoRejoin = value
    end)
...
function WebHookLog:SheetBestLogSend(SheetBestUrl)
	...
	Main3:Toggle("Auto Farm Bone",getgenv().Setting["Auto Farm Bone"],function(value)
		...
		if value == false then
		   ...
		   topos(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
			topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
			getgenv().Setting["Auto Farm Bone"] = false
		end
    end)
	Main3:Toggle("Auto Trade Bone",getgenv().Setting["Auto Random Bone"],function(value)
		getgenv().Setting["Auto Random Bone"] = value
    end)
	Main3:Toggle("Auto Hallow Scythe",getgenv().BossHallow,function(value)
		getgenv().BossHallow = value
    end)
	Main3:Toggle("Hallow Scythe Hop",getgenv().BossHallowHop,function(value)
	...
	Main3:Toggle("Fast Cake Prince",getgenv().Setting["Cake Prince"],function(value)
		getgenv().Setting["Cake Prince"] = value
		StopTween(getgenv().Setting["Cake Prince"])
	end)
	Main3:Toggle("Spawn Dought Boss",getgenv().Setting["Cake Prince Spawner"],function(value)
	...
	Main3:Toggle("Auto Ectoplasm",getgenv().Setting["Auto Farm Ectoplasm"],function(value)
	...
	Main3:Toggle("Elite Hunter",getgenv().Setting["Elite Hunter"],function(value)
		getgenv().Setting["Elite Hunter"] = value
            wait(1.1)
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter")
            StopTween(getgenv().Setting["Elite Hunter"])
	end)
	Main3:Toggle("Elite Hunter Hop",getgenv().Setting["Elite Hunter Hop"],function(value)
		getgenv().Setting["Elite Hunter Hop"] = value
		wait(500)
Hop()
	end)
...
local Tap2 = Window:Taps("Visual")
 ...
 Mainz:Label("🎡 Settings Boss 🎡")
	...
	Mainz:Toggle("Auto Farm Boss",getgenv().Setting["Auto Farm Boss"],function(value)
	...
	Mainz:Toggle("Auto Farm All Boss",false,function(value)
		...
		StopTween(getgenv().FarmAllBoss)
    end)
	Mainz:Toggle("All Boss Hop",getgenv().Setting["Auto Farm All Boss Hop"],function(value)
...
TP:Drop("Select Island",false,{
	...
	TP:Toggle("Auto Sea Beast",getgenv().SeaBeast,function(value)
		getgenv().SeaBeast = value
		StopTween(getgenv().SeaBeast) 
    end)
	TP:Toggle("Sea Beast Hop",getgenv().SeaBeastHop,function(value)
		getgenv().SeaBeastHop = value
    end)
	spawn(function()
		while wait() do
			if UseSkill then
		...
		if _G.Aimlock then
			pcall(function()
				...
				for i,v in pairs(game:GetService("Players"):GetChildren()) do 
					...
					if Dist < MaxDist and Dist <= _G.AimlockFOv and v.Name ~= game.Players.LocalPlayer.Name then
						MaxDist = Dist
						_G.Aim_Players = v
					end
				end
...
Circle.Color =  Color3.fromRGB(211,17,97)
Circle.Thickness = 1
Circle.Radius = 250
Circle.NumSides = 460
Circle.Filled = false
...
game:GetService("RunService").Stepped:Connect(function()
	...
	spawn(function()
		...
		spawn(function()
			while wait() do
				if _G.Auto_Next_Island2 then
					if not game.Players.LocalPlayer.PlayerGui.Main.Timer.Visible == false then
						if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
							getgenv().ToTarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame * CFrame.new(0,50,0))
						elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
							getgenv().ToTarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4").CFrame * CFrame.new(0,50,0))
						elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3") then
							getgenv().ToTarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 3").CFrame * CFrame.new(0,50,0))
						elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2") then
							getgenv().ToTarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 2").CFrame * CFrame.new(0,50,0))
						elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") then
							getgenv().ToTarget(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1").CFrame * CFrame.new(0,50,0))
						end
					end
				end
			end
		...
		spawn(function()
			while wait() do
				pcall(function()
				local a = require(game:GetService("ReplicatedStorage").Util.CameraShaker)
				a:Stop()
				end)
			end
		end)
		...
		local TPZ = Tap2:newpage()
TP:Label("🌀 Settings Buy 🌀")
TPZ:Drop("Select Buy",false,{"Black Leg","Electro","Fishman Karate","Dragon Claw","Superhuman","Death Step","Electric Claw","Sharkman Karate","Dragon Talon","Godhuman"},function(value)
	_G.Select_Buy = value
end)
TPZ:Toggle("Buy Select",false,function(value)
	_G.Buy = value
	if _G.Buy then
